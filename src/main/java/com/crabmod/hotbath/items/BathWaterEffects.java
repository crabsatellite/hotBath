...
public class BathWaterEffects {
    ...
    /**
     * Apply drink effects that are not supplied by item tags.
     * Tough As Nails handles built-in bottle warming, thirst, and hydration
     * through its consumed-item tags.
     */
