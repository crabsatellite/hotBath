...
public class CustomFluidTranslationManager {
    ...
    public static boolean hasTranslation(String key) {
        ...
        return !currentLang.equals(DEFAULT_LANGUAGE) && 
               getTranslationForLanguage(DEFAULT_LANGUAGE, key) != null;
    }
    ...
    private static String getTranslationForLanguage(String languageCode, String key) {
        Map<String, String> langMap = TRANSLATIONS.get(languageCode.toLowerCase());
        if (langMap != null) {
    ...
    public static void clearAll() {
        TRANSLATIONS.clear();
        LOGGER.debug("Cleared all custom fluid translations");
    }
    
    /**
     * Clears translations for a specific fluid.
     * 
     * @param translationKey The translation key to clear
     */
    public static void clearTranslation(String translationKey) {
        for (Map<String, String> langMap : TRANSLATIONS.values()) {
            langMap.remove(translationKey);
        }
    }
    
    /**
     * Gets the number of registered translations.
     * 
     * @return Total count of registered translations across all languages
     */
