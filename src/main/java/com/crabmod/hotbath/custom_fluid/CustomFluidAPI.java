 ...
 *     new ResourceLocation("hotbath", "golden_bath"));
 * 
...
public final class CustomFluidAPI {
    ...
    /**
     * Gets the trigger time of a custom fluid in seconds.
     * 
     * @param fluidId The resource location of the fluid
     * @return The trigger time, or -1 if not found
     */
    ...
    /**
     * Checks if a custom fluid is considered "hot" (temperature >= 30°C).
     * 
     * @param fluidId The resource location of the fluid
     * @return true if the fluid is hot, false otherwise or if not found
     */
    public static boolean isFluidHot(ResourceLocation fluidId) {
        return getFluidDefinition(fluidId)
    ...
    /**
     * Gets the total number of registered custom fluids.
     * 
     * @return The count of registered fluids
     */
    public static int getFluidCount() {
        return CustomFluidRegistry.getAllDefinitions().size();
    }
    ...
    public static ItemStack createBucket(ResourceLocation fluidId) {
        return CustomFluidNBTHelper.createStack(
    ...
    public static Optional<CustomFluidDefinition> getFluidFromItem(ItemStack stack) {
        CustomFluidDefinition def = CustomFluidNBTHelper.getFluidDefinition(stack);
