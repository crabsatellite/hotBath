...
public class LSOApiHelper {
    ...
    private static Holder<MobEffect> HOT_DRINK_HOLDER;
    ...
    private static Holder<MobEffect> getHotDrinkHolder() {
        if (HOT_DRINK_HOLDER == null) {
            HOT_DRINK_HOLDER = BuiltInRegistries.MOB_EFFECT.wrapAsHolder(MobEffectRegistry.HOT_DRINk.get());
        }
        return HOT_DRINK_HOLDER;
    }
    ...
    public static void applyBottleTemperatureEffect(Player player, boolean isBathing) {
        Holder<MobEffect> hotDrinkHolder = getHotDrinkHolder();
