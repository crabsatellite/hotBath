...
/**
 * Mixin plugin that conditionally loads Alex's Caves mixins only when the mod is present.
 * This prevents class loading errors when Alex's Caves is not installed.
 */
